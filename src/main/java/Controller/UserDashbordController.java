...
public class UserDashbordController {
    ...
    void add(ActionEvent event) {
        try {
            User u = new User(tfnom_ajout.getText(), tfprenom_ajout.getText(), tfemail_ajout.getText(), tfpwd_ajout.getText(), Integer.parseInt(tfnumero_ajout.getText()), tfadress_ajout.getText());
            us.add(u);
    ...
    public void statPi(){
        ...
        List<String> adress = observableList.stream()
                .map(User::getAdresse)
                .collect(Collectors.toList());

        // Count the occurrences of each discipline
        Map<String, Long> disciplineCounts = adress.stream()
                .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));

        // Create PieChart Data
        ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList();
        disciplineCounts.forEach((Adresse, count) -> {
            PieChart.Data data = new PieChart.Data(Adresse, count);
