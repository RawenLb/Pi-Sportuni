...
public class EvenementDashbordController {
    ObservableList<PieChart.Data>data=FXCollections.observableArrayList();
    private Connection cnx;
    @FXML
    private PieChart pi_chart_evenement;
    @FXML
    ...
    private void initTable() {
        ...
        cldateDebut.setCellValueFactory(new PropertyValueFactory<>("date_debut"));
        ...
        cldateFin.setCellValueFactory(new PropertyValueFactory<>("date_fin"));
    ...
    public void AjouterEvenementController() {
        evenementService = new EvenementService();
    ...
    void AjouterEvenement(ActionEvent event) {
        ...
        if (selectedid == 0) {
            ...
            Evenement evenement = new Evenement(selectedid, nomE, selectedSalle.getNom(), Date.valueOf(dateDebutVal), nomDiscipline, descriptionVal, nbrMax, Date.valueOf(dateFinVal));
    ...
    public void sauvegarder(ActionEvent actionEvent) {
        ...
        selectedEvenement.setDate_debut(Date.valueOf(dateDebutVal));
        ...
        selectedEvenement.setDate_fin(Date.valueOf(dateFinVal));
        System.out.println(selectedEvenement);
...
//        hiddenButton.setVisible(false);
    ...
    public void postFacebook(MouseEvent mouseEvent) {
        ...
        String accessTokenString = "EAAM8vWsiK8MBO778eDb8cZAyZCE9qnGleIMcP7tiD9rgfbx4ZCmCS2wriKVNRbMOSMEkSXv37P0jkmgfwqZB9WQHBKltujsnRLJFqBfoWJVIpgRAlrpxnw8Amn6qJZANdFIxLQZBYRjWrpWlnXQfOtgV6ePCoXCwRiZBOwTOoFm7pRUlZAPCvYSZCW7ghXZAo6gmQSZCfyLjbaD2Y09T3ZCfpiYwCioU";
        ...
        String msg = "Rejoinez notre Event! "
                ...
                + "starting on at"
                + event.getDate_debut()+".Book your application now via our desktop app.";
    ...
    private void stat()
    {
        ...
        pi_chart_evenement.setTitle("*Statistiques des evenements par salle *");
        pi_chart_evenement.setLegendSide(Side.LEFT);
        pi_chart_evenement.setData(data);
